                  ...
                  <table class="table text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <div class="media-left media-middle">
                            <a href="#"><img src="{{base_url()}}assets/images/brands/facebook.png" class="img-circle img-xs" alt=""></a>
                          </div>
                          <div class="media-left">
                      ...
                      <tr>
                        <td>
                          <div class="media-left media-middle">
                            <a href="#"><img src="{{base_url()}}assets/images/brands/youtube.png" class="img-circle img-xs" alt=""></a>
                          </div>
                          <div class="media-left">
                      ...
                      <tr>
                        <td>
                          <div class="media-left media-middle">
                            <a href="#"><img src="{{base_url()}}assets/images/brands/spotify.png" class="img-circle img-xs" alt=""></a>
                          </div>
                          <div class="media-left">
                      ...
                      <tr>
                        <td>
                          <div class="media-left media-middle">
                            <a href="#"><img src="{{base_url()}}assets/images/brands/twitter.png" class="img-circle img-xs" alt=""></a>
                          </div>
                          <div class="media-left">
                      ...
                      <tr>
                        <td>
                          <div class="media-left media-middle">
                            <a href="#"><img src="{{base_url()}}assets/images/brands/bing.png" class="img-circle img-xs" alt=""></a>
                          </div>
                          <div class="media-left">
                      ...
                      <tr>
                        <td>
                          <div class="media-left media-middle">
                            <a href="#"><img src="{{base_url()}}assets/images/brands/amazon.png" class="img-circle img-xs" alt=""></a>
                          </div>
                          <div class="media-left">
                      ...
                      <tr>
                        <td>
                          <div class="media-left media-middle">
                            <a href="#"><img src="{{base_url()}}assets/images/brands/dribbble.png" class="img-circle img-xs" alt=""></a>
                          </div>
                          <div class="media-left">
                  ...
                  <table class="table text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="media-left media-middle">
                            <a href="#"><img src="{{base_url()}}assets/images/placeholder.jpg" class="img-circle img-xs" alt=""></a>
                          </div>
                    ...
                    <div class="col-lg-6">
                      <ul class="media-list content-group">
                        <li class="media stack-media-on-mobile">
                            ...
                            <div class="thumb">
                              <a href="#">
                                <img src="{{base_url()}}assets/images/placeholder.jpg" class="img-responsive img-rounded media-preview" alt="">
                ...
                <div class="tab-content">
                  <div class="tab-pane active fade in has-padding" id="messages-tue">
                    <ul class="media-list">
                      <li class="media">
                        <div class="media-left">
                          <img src="{{base_url()}}assets/images/placeholder.jpg" class="img-circle img-xs" alt="">
